...
func TestAppendEntriesResponseProto(t *testing.T) {
...
func TestAppendEntriesResponseMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedAppendEntriesResponse(popr, false)
	size := p.Size()
...
func BenchmarkAppendEntriesResponseProtoMarshal(b *testing.B) {
...
func BenchmarkAppendEntriesResponseProtoUnmarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_golang_protobuf_proto.Marshal(NewPopulatedAppendEntriesResponse(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func TestAppendEntriesResponseJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
...
func TestAppendEntriesResponseProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedAppendEntriesResponse(popr, true)
...
func TestAppendEntriesResponseProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedAppendEntriesResponse(popr, true)
...
func TestAppendEntriesResponseVerboseEqual(t *testing.T) {
...
func TestAppendEntriesResponseGoString(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedAppendEntriesResponse(popr, false)
	s1 := p.GoString()
	s2 := fmt.Sprintf("%#v", p)
...
func TestAppendEntriesResponseSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedAppendEntriesResponse(popr, true)
...
func BenchmarkAppendEntriesResponseSize(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
...
func TestAppendEntriesResponseStringer(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedAppendEntriesResponse(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
