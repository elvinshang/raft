...
func TestRequestVoteRequestProto(t *testing.T) {
...
func TestRequestVoteRequestMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedRequestVoteRequest(popr, false)
	size := p.Size()
...
func BenchmarkRequestVoteRequestProtoMarshal(b *testing.B) {
...
func BenchmarkRequestVoteRequestProtoUnmarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_golang_protobuf_proto.Marshal(NewPopulatedRequestVoteRequest(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func TestRequestVoteRequestJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
...
func TestRequestVoteRequestProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedRequestVoteRequest(popr, true)
...
func TestRequestVoteRequestProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedRequestVoteRequest(popr, true)
...
func TestRequestVoteRequestVerboseEqual(t *testing.T) {
...
func TestRequestVoteRequestGoString(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedRequestVoteRequest(popr, false)
	s1 := p.GoString()
	s2 := fmt.Sprintf("%#v", p)
...
func TestRequestVoteRequestSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedRequestVoteRequest(popr, true)
...
func BenchmarkRequestVoteRequestSize(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
...
func TestRequestVoteRequestStringer(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedRequestVoteRequest(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
