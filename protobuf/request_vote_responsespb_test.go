...
func TestRequestVoteResponseProto(t *testing.T) {
...
func TestRequestVoteResponseMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedRequestVoteResponse(popr, false)
	size := p.Size()
...
func BenchmarkRequestVoteResponseProtoMarshal(b *testing.B) {
...
func BenchmarkRequestVoteResponseProtoUnmarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_golang_protobuf_proto.Marshal(NewPopulatedRequestVoteResponse(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func TestRequestVoteResponseJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
...
func TestRequestVoteResponseProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedRequestVoteResponse(popr, true)
...
func TestRequestVoteResponseProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedRequestVoteResponse(popr, true)
...
func TestRequestVoteResponseVerboseEqual(t *testing.T) {
...
func TestRequestVoteResponseGoString(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedRequestVoteResponse(popr, false)
	s1 := p.GoString()
	s2 := fmt.Sprintf("%#v", p)
...
func TestRequestVoteResponseSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedRequestVoteResponse(popr, true)
...
func BenchmarkRequestVoteResponseSize(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
...
func TestRequestVoteResponseStringer(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedRequestVoteResponse(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
