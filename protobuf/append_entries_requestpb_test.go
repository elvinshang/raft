...
func TestAppendEntriesRequestProto(t *testing.T) {
...
func TestAppendEntriesRequestMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedAppendEntriesRequest(popr, false)
	size := p.Size()
...
func BenchmarkAppendEntriesRequestProtoMarshal(b *testing.B) {
...
func BenchmarkAppendEntriesRequestProtoUnmarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_golang_protobuf_proto.Marshal(NewPopulatedAppendEntriesRequest(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func TestAppendEntriesRequestJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
...
func TestAppendEntriesRequestProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedAppendEntriesRequest(popr, true)
...
func TestAppendEntriesRequestProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedAppendEntriesRequest(popr, true)
...
func TestAppendEntriesRequestVerboseEqual(t *testing.T) {
...
func TestAppendEntriesRequestGoString(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedAppendEntriesRequest(popr, false)
	s1 := p.GoString()
	s2 := fmt.Sprintf("%#v", p)
...
func TestAppendEntriesRequestSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedAppendEntriesRequest(popr, true)
...
func BenchmarkAppendEntriesRequestSize(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
...
func TestAppendEntriesRequestStringer(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedAppendEntriesRequest(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
